...
Este documento recoge los requisitos del sistema propuesto en el Trabajo de Fin de Grado, cuyo objetivo es el desarrollo de un prototipo funcional de un visor en realidad aumentada orientado a incrementar la seguridad durante el vuelo.
El sistema está concebido como un concepto, utilizando un visor de realidad virtual (Meta Quest 3) como soporte experimental. El principal objetivo del sistema es la prevención de posibles colisiones aéreas, mediante la visualización en tiempo real del tráfico cercano, así como la incorporación de información relevante para el piloto sin necesidad de desviar la atención de los instrumentos principales.
